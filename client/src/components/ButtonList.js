		...
		return(
			<div id="nav" className="button-list content-container">
				<Button 
			   	...
			   	<Button 
					   color={this.props.selectedTopic === "perl" ? "primary" : "info"} 
					   value="perl" 
					   onClick={this.handleClick}>Perl
				</Button>{' '}

				<Button 
					color={this.props.selectedTopic === "python" ? "primary" : "info"} 
					value="python" 
					onClick={this.handleClick}>Python
				</Button>{' '}

				<Button 
				   color={this.props.selectedTopic === "ruby" ? "primary" : "info"} 
				   value="ruby" 
				   onClick={this.handleClick}>Ruby
				</Button>{' '}

				<Button 
				   color={this.props.selectedTopic === "angular" ? "primary" : "info"} 
				   value="angular" 
